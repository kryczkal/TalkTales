...
class Settings:
    ...
    # WARNING !!!
    # Segments denotes the amount of single amplitude samples package downloaded from stream.
    # Per computation one segment is processed.
    ...
    TEST_DELAY_IN_MS = 3000 # in milliseconds
    SPEECH_PROB_THRESHOLD = 0.6 # above this value we assumes that segment contains actual human speech
