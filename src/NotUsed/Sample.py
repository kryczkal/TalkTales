...
class VoiceSample:
    """
    Class used to represent a single audio sample.
    Contains raw byte data, converted data,
    timestamp of creation of the object and methods
    to calculate mfcc of the sample.
    """
    ...
    def mfcc_get(self):
        ...
        self.mfcc = libr_mfcc(y=self.data, sr=Settings.FREQUENCY,
                              n_mfcc=13, fmin=100, fmax=8000, lifter=1,
                              n_fft=int(Settings.FREQUENCY * 10 / 1000))
    ...
    def data_convert(self):
        ...
        self.data = np.frombuffer(self.byte_data, dtype=Settings.DATAFORMAT)

        if Settings.STREAMFORMAT == py.paInt16:
